  ...
  return (
    <svg width={width} className={classname} height={height} viewBox="0 0 24 24" fill={boxFill} xmlns="http://www.w3.org/2000/svg">
      <g id="arrow-up">
        ...
        <path id="Vector_2" d="M12 21.25C11.59 21.25 11.25 20.91 11.25 20.5V3.67001C11.25 3.26001 11.59 2.92001 12 2.92001C12.41 2.92001 12.75 3.26001 12.75 3.67001V20.5C12.75 20.91 12.41 21.25 12 21.25Z"/>
      </g>
    </svg>
